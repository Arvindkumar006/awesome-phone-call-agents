...
- [ResolveCall](https://github.com/Arvindkumar006/RESOLVECALL) - Autonomous operational recovery agent that places real-time CALL-E phone calls to negotiate delivery windows, extract structured commitments, and deterministically verify policies when vendor APIs are unavailable.
